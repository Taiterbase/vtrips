module github.com/Taiterbase/vtrips/pkg/index

go 1.23.1

require (
	github.com/Taiterbase/vtrips/pkg/models v0.0.1
...
replace github.com/Taiterbase/vtrips/pkg/models v0.0.1 => ../../pkg/models
